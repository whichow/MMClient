...
public class EmojiBuilder  {
    ...
    private const string OutputPath = "Assets/Resources/EmojiDerivative/";//"Assets/Emoji/Output/";
	private const string InputPath = "/Resources/Textures/CommonExpression/";//"/Emoji/Input/";
	...
	private const int EmojiSize = 128;//the size of emoji.
	...
	public static void BuildEmoji()
	{
		...
		File.Copy (OutputPath + "emoji.txt", "Assets/Resources/Configs/emoji.txt", true);
