...
#pragma warning restore 0414
	...
	static AndroidJavaClass _igaworksUnityPluginAosClass = null;
        ...
        {
#if UNITY_EDITOR
            Debug.Log(">>> igaworks: Editor mode Connected --- InitPlugin");
#elif UNITY_ANDROID
        ...
        public static class Common
        {
            ...
            {
#if UNITY_EDITOR
                Debug.Log(">>> igaworks: Editor mode Connected --- startSession");
#elif UNITY_ANDROID
                if (_igaworksUnityPluginAosClass != null)
                {
            ...
            {
#if UNITY_EDITOR
                Debug.Log(">>> igaworks: Editor mode Connected --- endSession");
#elif UNITY_ANDROID
                if (_igaworksUnityPluginAosClass != null)
                {
...
#pragma warning restore 0414    // suppress value not used warning
            ...
            {
#if UNITY_EDITOR
                Debug.Log(">>> igaworks: Editor mode Connected --- firstTimeExperience");
#elif UNITY_ANDROID
            ...
            {
#if UNITY_EDITOR
                Debug.Log(">>> igaworks: Editor mode Connected --- retention");
#elif UNITY_ANDROID
