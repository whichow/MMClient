...
namespace ToolGood.Words.internals
{
    public class TrieNode
    {
        ...
        private ushort minflag = ushort.MaxValue;
        private ushort maxflag = ushort.MinValue;
        ...
        {
            m_values = new Dictionary<char, TrieNode>(size + 1);
            Results = new List<string>();
        }
        ...
        public TrieNode Add(char c, int size = 0)
        {
            TrieNode node;
