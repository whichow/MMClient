...
// Last Modified On : 
// ***********************************************************************
// <copyright file= "KUIGridEditor" company=""></copyright>
// <summary></summary>
// ***********************************************************************
using UnityEditor;
...
[CustomEditor(typeof(KUIGrid), true)]
[CanEditMultipleObjects]
public class KUIGridEditor : Editor
{
    ...
    {
        SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)KUIGrid.MovementType.Elastic, instant);
    ...
    void CalculateCachedValues()
    {
        ...
        if (targets.Length == 1)
        {
            Transform transform = ((KUIGrid)target).transform;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
        {
            ...
            if ((KUIGrid.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == KUIGrid.ScrollbarVisibility.AutoHideAndExpandViewport
        ...
        if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
        {
            ...
            if ((KUIGrid.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == KUIGrid.ScrollbarVisibility.AutoHideAndExpandViewport
