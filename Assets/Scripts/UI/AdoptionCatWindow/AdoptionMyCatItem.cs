...
//namespace Game.UI
//{
//    public class AdoptionMyCatItem : KUIItem, IPointerClickHandler
//    {
//        #region Field
...
//        {
//            var catList = KUIWindow.GetWindow<AdoptionCatWindow>()._catsList;

//            if (_transBlack.gameObject.activeSelf == false && KFoster.Instance.selfSlots.Count < catList.Length)
//            {
//                KUIWindow.GetWindow<AdoptionCatWindow>().AddCat(cat);
//            }
//            //else
//            //{
